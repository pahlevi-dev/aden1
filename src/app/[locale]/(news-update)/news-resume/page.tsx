...
import { CarouselContainer } from '@/components/newsUpdates/CarouselContainer';
...
export default async function NewsResumeListPage({
  searchParams,
  params,
}: IProps) {
  ...
  const t = await getTranslations('NewsUpdates');
  const locale = (await params).locale;
  ...
  return (
    <div className="container mx-auto px-5 space-y-5">
      ...
      <CarouselContainer data={data.blogPosts} />
